...
void OpenGlWindowBind(const OpenGlWindow* context, GLuint program) {
  GLint win0_bg0 = glGetUniformLocation(program, "win0.bg[0]");
  glUniform1i(win0_bg0, context->win0_bg0);

  GLint win0_bg1 = glGetUniformLocation(program, "win0.bg[1]");
  glUniform1i(win0_bg1, context->win0_bg1);

  GLint win0_bg2 = glGetUniformLocation(program, "win0.bg[2]");
  glUniform1i(win0_bg2, context->win0_bg2);

  GLint win0_bg3 = glGetUniformLocation(program, "win0.bg[3]");
  ...
  GLint win1_bg0 = glGetUniformLocation(program, "win1.bg[0]");
  glUniform1i(win1_bg0, context->win1_bg0);

  GLint win1_bg1 = glGetUniformLocation(program, "win1.bg[1]");
  glUniform1i(win1_bg1, context->win1_bg1);

  GLint win1_bg2 = glGetUniformLocation(program, "win1.bg[2]");
  glUniform1i(win1_bg2, context->win1_bg2);

  GLint win1_bg3 = glGetUniformLocation(program, "win1.bg[3]");
  ...
  GLint winobj_bg0 = glGetUniformLocation(program, "winobj.bg[0]");
  glUniform1i(winobj_bg0, context->winobj_bg0);

  GLint winobj_bg1 = glGetUniformLocation(program, "winobj.bg[1]");
  glUniform1i(winobj_bg1, context->winobj_bg1);

  GLint winobj_bg2 = glGetUniformLocation(program, "winobj.bg[2]");
  glUniform1i(winobj_bg2, context->winobj_bg2);

  GLint winobj_bg3 = glGetUniformLocation(program, "winobj.bg[3]");
  ...
  GLint winout_bg0 = glGetUniformLocation(program, "winout.bg[0]");
  glUniform1i(winout_bg0, context->winout_bg0);

  GLint winout_bg1 = glGetUniformLocation(program, "winout.bg[1]");
  glUniform1i(winout_bg1, context->winout_bg1);

  GLint winout_bg2 = glGetUniformLocation(program, "winout.bg[2]");
  glUniform1i(winout_bg2, context->winout_bg2);

  GLint winout_bg3 = glGetUniformLocation(program, "winout.bg[3]");
