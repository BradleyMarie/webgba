...
TEST_F(ExecuteTest, LDR_DAW) {
  ...
  EXPECT_FALSE(RunInstruction("0x012010E6"));  // ldr r2, [r0], -r1
  EXPECT_EQ(0x2FCu, registers_.current.user.gprs.r0);
  ...
  uint32_t pc = registers_.current.user.gprs.pc;
  registers_.current.user.gprs.r0 = 0x300u;
  EXPECT_TRUE(RunInstruction("0x01F010E6"));  // ldr pc, [r0], -r1

  registers_.current.user.gprs.pc = pc + 4u;
  EXPECT_TRUE(RunInstruction("0x0E00FFE9"));  // ldr r0, [pc], -r1
}
...
TEST_F(ExecuteTest, LDR_DAW_I12) {
  ...
  EXPECT_FALSE(RunInstruction("0x042010E4"));  // ldr r2, [r0], #-4
  EXPECT_EQ(0x2FCu, registers_.current.user.gprs.r0);
  EXPECT_EQ(1u, registers_.current.user.gprs.r2);
  ...
  uint32_t pc = registers_.current.user.gprs.pc;
  registers_.current.user.gprs.r0 = 0x300u;
  EXPECT_TRUE(RunInstruction("0x04F010E4"));  // ldr pc, [r0], #-4

  registers_.current.user.gprs.pc = pc + 4u;
  EXPECT_TRUE(RunInstruction("0x04001FE4"));  // ldr r0, [pc], #-4
}
...
TEST_F(ExecuteTest, LDR_DB) {
  ...
  EXPECT_FALSE(RunInstruction("0x012010E7"));  // ldr r2, [r0, -r1]
  EXPECT_EQ(1u, registers_.current.user.gprs.r2);

  // Modifies PC
  registers_.current.user.gprs.r0 = 0x304u;
  EXPECT_TRUE(RunInstruction("0x01F010E7"));  // ldr pc, [r0, -r1]
}
...
TEST_F(ExecuteTest, LDR_DB_I12) {
  ...
  EXPECT_FALSE(RunInstruction("0x042010E5"));  // ldr r2, [r0, #-4]
  EXPECT_EQ(1u, registers_.current.user.gprs.r2);

  // Modifies PC
  registers_.current.user.gprs.r0 = 0x304u;
  EXPECT_TRUE(RunInstruction("0x04F010E5"));  // ldr pc, [r0, #-4]
}
...
TEST_F(ExecuteTest, LDR_DBW) {
  ...
  EXPECT_FALSE(RunInstruction("0x012030E7"));  // ldr r2, [r0, -r1]!
  EXPECT_EQ(0x300u, registers_.current.user.gprs.r0);
  EXPECT_EQ(1u, registers_.current.user.gprs.r2);
  ...
  uint32_t pc = registers_.current.user.gprs.pc;
  registers_.current.user.gprs.r0 = 0x304u;
  EXPECT_TRUE(RunInstruction("0x01F030E7"));  // ldr pc, [r0, -r1]!

  registers_.current.user.gprs.pc = pc + 4u;
  EXPECT_TRUE(RunInstruction("0x01003FE7"));  // ldr r0, [pc, -r1]!
}
...
TEST_F(ExecuteTest, LDR_DBW_I12) {
  ...
  EXPECT_FALSE(RunInstruction("0x042030E5"));  // ldr r2, [r0, #-4]!
  EXPECT_EQ(0x300u, registers_.current.user.gprs.r0);
  EXPECT_EQ(1u, registers_.current.user.gprs.r2);
  ...
  uint32_t pc = registers_.current.user.gprs.pc;
  registers_.current.user.gprs.r0 = 0x304u;
  EXPECT_TRUE(RunInstruction("0x04F030E5"));  // ldr pc, [r0, #-4]!

  registers_.current.user.gprs.pc = pc + 4u;
  EXPECT_TRUE(RunInstruction("0x04003FE5"));  // ldr r0, [pc, #-4]!
}
...
TEST_F(ExecuteTest, LDR_IAW) {
  ...
  EXPECT_FALSE(RunInstruction("0x012090E6"));  // ldr r2, [r0], r1
  ...
  uint32_t pc = registers_.current.user.gprs.pc;
  registers_.current.user.gprs.r0 = 0x304u;
  EXPECT_TRUE(RunInstruction("0x01F090E6"));  // ldr pc, [r0], r1

  registers_.current.user.gprs.pc = pc + 4u;
  EXPECT_TRUE(RunInstruction("0x01009FE6"));  // ldr r0, [pc], r1
}
...
TEST_F(ExecuteTest, LDR_IAW_I12) {
  ...
  EXPECT_FALSE(RunInstruction("0x042090E4"));  // ldr r2, [r0], #4
  EXPECT_EQ(0x304u, registers_.current.user.gprs.r0);
  EXPECT_EQ(1u, registers_.current.user.gprs.r2);
  ...
  uint32_t pc = registers_.current.user.gprs.pc;
  registers_.current.user.gprs.r0 = 0x300u;
  EXPECT_TRUE(RunInstruction("0x04F090E4"));  // ldr pc, [r0], #4

  registers_.current.user.gprs.pc = pc + 4u;
  EXPECT_TRUE(RunInstruction("0x04009FE4"));  // ldr r0, [pc], #4
}
...
TEST_F(ExecuteTest, LDR_IB) {
  ...
  EXPECT_FALSE(RunInstruction("0x012090E7"));  // ldr r2, [r0, r1]
  EXPECT_EQ(1u, registers_.current.user.gprs.r2);

  // Modifies PC
  registers_.current.user.gprs.r0 = 0x2FC;
  EXPECT_TRUE(RunInstruction("0x01F090E7"));  // ldr pc, [r0, r1]
}
...
TEST_F(ExecuteTest, LDR_IB_I12) {
  ...
  EXPECT_FALSE(RunInstruction("0x042090E5"));  // ldr r2, [r0, #4]
  EXPECT_EQ(1u, registers_.current.user.gprs.r2);

  // Modifies PC
  registers_.current.user.gprs.r0 = 0x2FC;
  EXPECT_TRUE(RunInstruction("0x04F090E5"));  // ldr pc, [r0, #4]
}
...
TEST_F(ExecuteTest, LDR_IBW) {
  ...
  EXPECT_FALSE(RunInstruction("0x0120B0E7"));  // ldr r2, [r0, r1]!
  EXPECT_EQ(0x300u, registers_.current.user.gprs.r0);
  EXPECT_EQ(1u, registers_.current.user.gprs.r2);
  ...
  uint32_t pc = registers_.current.user.gprs.pc;
  registers_.current.user.gprs.r0 = 0x2FCu;
  EXPECT_TRUE(RunInstruction("0x01F0B0E7"));  // ldr pc, [r0, r1]!

  registers_.current.user.gprs.pc = pc + 4u;
  EXPECT_TRUE(RunInstruction("0x0100BFE7"));  // ldr r0, [pc, r1]!
}
...
TEST_F(ExecuteTest, LDR_IBW_I12) {
  ...
  EXPECT_FALSE(RunInstruction("0x0420B0E5"));  // ldr r2, [r0, #4]!
  EXPECT_EQ(0x300u, registers_.current.user.gprs.r0);
  EXPECT_EQ(1u, registers_.current.user.gprs.r2);
  ...
  uint32_t pc = registers_.current.user.gprs.pc;
  registers_.current.user.gprs.r0 = 0x2FCu;
  EXPECT_TRUE(RunInstruction("0x04F0B0E5"));  // ldr pc, [r0, #4]!

  registers_.current.user.gprs.pc = pc + 4u;
  EXPECT_TRUE(RunInstruction("0x0400BFE5"));  // ldr r0, [pc, #4]!
}
...
TEST_F(ExecuteTest, LDRB_DAW) {
  ...
  EXPECT_FALSE(RunInstruction("0x012050E6"));  // ldrb r2, [r0], -r1
  EXPECT_EQ(0x2FCu, registers_.current.user.gprs.r0);
  EXPECT_EQ(1u, registers_.current.user.gprs.r2);
  ...
  uint32_t pc = registers_.current.user.gprs.pc;
  registers_.current.user.gprs.r0 = 0x300u;
  EXPECT_TRUE(RunInstruction("0x01F050E6"));  // ldrb pc, [r0], -r1

  registers_.current.user.gprs.pc = pc + 4u;
  EXPECT_TRUE(RunInstruction("0x01005FE6"));  // ldrb r0, [pc], -r1
}
...
TEST_F(ExecuteTest, LDRB_DAW_I12) {
  ...
  EXPECT_FALSE(RunInstruction("0x042050E4"));  // ldrb r2, [r0], #-4
  EXPECT_EQ(0x2FCu, registers_.current.user.gprs.r0);
  EXPECT_EQ(1u, registers_.current.user.gprs.r2);
  ...
  uint32_t pc = registers_.current.user.gprs.pc;
  registers_.current.user.gprs.r0 = 0x300u;
  EXPECT_TRUE(RunInstruction("0x04F050E4"));  // ldrb pc, [r0], #-4

  registers_.current.user.gprs.pc = pc + 4u;
  EXPECT_TRUE(RunInstruction("0x04005FE4"));  // ldrb r0, [pc], #-4
}
...
TEST_F(ExecuteTest, LDRB_DB) {
  ...
  EXPECT_FALSE(RunInstruction("0x012050E7"));  // ldrb r2, [r0, -r1]
  EXPECT_EQ(1u, registers_.current.user.gprs.r2);

  // Modifies PC
  registers_.current.user.gprs.r0 = 0x304u;
  EXPECT_TRUE(RunInstruction("0x01F050E7"));  // ldrb pc, [r0, -r1]
}
...
TEST_F(ExecuteTest, LDRB_DB_I12) {
  ...
  EXPECT_FALSE(RunInstruction("0x042050E5"));  // ldrb r2, [r0, #-4]
  EXPECT_EQ(1u, registers_.current.user.gprs.r2);

  // Modifies PC
  registers_.current.user.gprs.r0 = 0x304u;
  EXPECT_TRUE(RunInstruction("0x04F050E5"));  // ldrb pc, [r0, #-4]
}
...
TEST_F(ExecuteTest, LDRB_DBW) {
  ...
  EXPECT_FALSE(RunInstruction("0x012070E7"));  // ldrb r2, [r0, -r1]!
  EXPECT_EQ(0x300u, registers_.current.user.gprs.r0);
  EXPECT_EQ(1u, registers_.current.user.gprs.r2);
  ...
  uint32_t pc = registers_.current.user.gprs.pc;
  registers_.current.user.gprs.r0 = 0x304u;
  EXPECT_TRUE(RunInstruction("0x01F070E7"));  // ldrb pc, [r0, -r1]!

  registers_.current.user.gprs.pc = pc + 4u;
  EXPECT_TRUE(RunInstruction("0x01007FE7"));  // ldrb r0, [pc, -r1]!
}
...
TEST_F(ExecuteTest, LDRB_DBW_I12) {
  ...
  EXPECT_FALSE(RunInstruction("0x042070E5"));  // ldrb r2, [r0, #-4]!
  EXPECT_EQ(0x300u, registers_.current.user.gprs.r0);
  EXPECT_EQ(1u, registers_.current.user.gprs.r2);
  ...
  uint32_t pc = registers_.current.user.gprs.pc;
  registers_.current.user.gprs.r0 = 0x304u;
  EXPECT_TRUE(RunInstruction("0x04F070E5"));  // ldrb pc, [r0, #-4]!

  registers_.current.user.gprs.pc = pc + 4u;
  EXPECT_TRUE(RunInstruction("0x04007FE5"));  // ldrb r0, [pc, #-4]!
}
...
TEST_F(ExecuteTest, LDRB_IAW) {
  ...
  EXPECT_FALSE(RunInstruction("0x0120D0E6"));  // ldrb r2, [r0], r1
  EXPECT_EQ(0x304u, registers_.current.user.gprs.r0);
  EXPECT_EQ(1u, registers_.current.user.gprs.r2);
  ...
  uint32_t pc = registers_.current.user.gprs.pc;
  registers_.current.user.gprs.r0 = 0x304u;
  EXPECT_TRUE(RunInstruction("0x01F0D0E6"));  // ldrb pc, [r0], r1

  registers_.current.user.gprs.pc = pc + 4u;
  EXPECT_TRUE(RunInstruction("0x0100DFE6"));  // ldrb r0, [pc], r1
}
...
TEST_F(ExecuteTest, LDRB_IAW_I12) {
  ...
  EXPECT_FALSE(RunInstruction("0x0420D0E4"));  // ldrb r2, [r0], #4
  EXPECT_EQ(0x304u, registers_.current.user.gprs.r0);
  EXPECT_EQ(1u, registers_.current.user.gprs.r2);
  ...
  uint32_t pc = registers_.current.user.gprs.pc;
  registers_.current.user.gprs.r0 = 0x300u;
  EXPECT_TRUE(RunInstruction("0x04F0D0E4"));  // ldrb pc, [r0], #4

  registers_.current.user.gprs.pc = pc + 4u;
  EXPECT_TRUE(RunInstruction("0x0400DFE4"));  // ldrb r0, [pc], #4
}
...
TEST_F(ExecuteTest, LDRB_IB) {
  ...
  EXPECT_FALSE(RunInstruction("0x0120D0E7"));  // ldrb r2, [r0, r1]
  EXPECT_EQ(1u, registers_.current.user.gprs.r2);

  // Modifies PC
  registers_.current.user.gprs.r0 = 0x2FC;
  EXPECT_TRUE(RunInstruction("0x01F0D0E7"));  // ldrb pc, [r0, r1]
}
...
TEST_F(ExecuteTest, LDRB_IB_I12) {
  ...
  EXPECT_FALSE(RunInstruction("0x0420D0E5"));  // ldrb r2, [r0, #4]
  EXPECT_EQ(1u, registers_.current.user.gprs.r2);

  // Modifies PC
  registers_.current.user.gprs.r0 = 0x2FC;
  EXPECT_TRUE(RunInstruction("0x04F0D0E5"));  // ldrb pc, [r0, #4]
}
...
TEST_F(ExecuteTest, LDRB_IBW) {
  ...
  EXPECT_FALSE(RunInstruction("0x0120F0E7"));  // ldrb r2, [r0, r1]!
  EXPECT_EQ(0x300u, registers_.current.user.gprs.r0);
  EXPECT_EQ(1u, registers_.current.user.gprs.r2);
  ...
  uint32_t pc = registers_.current.user.gprs.pc;
  registers_.current.user.gprs.r0 = 0x2FCu;
  EXPECT_TRUE(RunInstruction("0x01F0F0E7"));  // ldrb pc, [r0, r1]!

  registers_.current.user.gprs.pc = pc + 4u;
  EXPECT_TRUE(RunInstruction("0x0100FFE7"));  // ldrb r0, [pc, r1]!
}
...
TEST_F(ExecuteTest, LDRB_IBW_I12) {
  ...
  EXPECT_FALSE(RunInstruction("0x0420F0E5"));  // ldrb r2, [r0, #4]!
  EXPECT_EQ(0x300u, registers_.current.user.gprs.r0);
  EXPECT_EQ(1u, registers_.current.user.gprs.r2);
  ...
  uint32_t pc = registers_.current.user.gprs.pc;
  registers_.current.user.gprs.r0 = 0x2FCu;
  EXPECT_TRUE(RunInstruction("0x04F0F0E5"));  // ldrb pc, [r0, #4]!

  registers_.current.user.gprs.pc = pc + 4u;
  EXPECT_TRUE(RunInstruction("0x0400FFE5"));  // ldrb r0, [pc, #4]!
}
...
TEST_F(ExecuteTest, LDRBT_DAW) {
  ...
  EXPECT_FALSE(RunInstruction("0x012070E6"));  // ldrbt r2, [r0], -r1
  EXPECT_EQ(0x2FCu, registers_.current.user.gprs.r0);
  EXPECT_EQ(1u, registers_.current.user.gprs.r2);
  ...
  uint32_t pc = registers_.current.user.gprs.pc;
  registers_.current.user.gprs.r0 = 0x300u;
  EXPECT_TRUE(RunInstruction("0x01F070E6"));  // ldrbt pc, [r0], -r1

  registers_.current.user.gprs.pc = pc + 4u;
  EXPECT_TRUE(RunInstruction("0x01007FE6"));  // ldrbt r0, [pc], -r1
}
...
TEST_F(ExecuteTest, LDRBT_DAW_I12) {
  ...
  EXPECT_FALSE(RunInstruction("0x042070E4"));  // ldrbt r2, [r0], #-4
  EXPECT_EQ(0x2FCu, registers_.current.user.gprs.r0);
  EXPECT_EQ(1u, registers_.current.user.gprs.r2);
  ...
  uint32_t pc = registers_.current.user.gprs.pc;
  registers_.current.user.gprs.r0 = 0x300u;
  EXPECT_TRUE(RunInstruction("0x04F070E4"));  // ldrbt pc, [r0], #-4

  registers_.current.user.gprs.pc = pc + 4u;
  EXPECT_TRUE(RunInstruction("0x04007FE4"));  // ldrbt r0, [pc], #-4
}
...
TEST_F(ExecuteTest, LDRBT_IAW) {
  ...
  EXPECT_FALSE(RunInstruction("0x0120F0E6"));  // ldrbt r2, [r0], r1
  EXPECT_EQ(0x304u, registers_.current.user.gprs.r0);
  EXPECT_EQ(1u, registers_.current.user.gprs.r2);
  ...
  uint32_t pc = registers_.current.user.gprs.pc;
  registers_.current.user.gprs.r0 = 0x304u;
  EXPECT_TRUE(RunInstruction("0x01F0F0E6"));  // ldrbt pc, [r0], r1

  registers_.current.user.gprs.pc = pc + 4u;
  EXPECT_TRUE(RunInstruction("0x0100FFE6"));  // ldrbt r0, [pc], r1
}
...
TEST_F(ExecuteTest, LDRBT_IAW_I12) {
  ...
  EXPECT_FALSE(RunInstruction("0x0420F0E4"));  // ldrbt r2, [r0], #4
  EXPECT_EQ(0x304u, registers_.current.user.gprs.r0);
  EXPECT_EQ(1u, registers_.current.user.gprs.r2);
  ...
  uint32_t pc = registers_.current.user.gprs.pc;
  registers_.current.user.gprs.r0 = 0x300u;
  EXPECT_TRUE(RunInstruction("0x04F0F0E4"));  // ldrbt pc, [r0], #4
...
TEST_F(ExecuteTest, LDRSB_DAW) {
  ...
  EXPECT_FALSE(RunInstruction("0xD12010E0"));  // ldrsb r2, [r0], -r1
  EXPECT_EQ(0x2FCu, registers_.current.user.gprs.r0);
  ...
  uint32_t pc = registers_.current.user.gprs.pc;
  registers_.current.user.gprs.r0 = 0x300u;
  EXPECT_TRUE(RunInstruction("0xD1F010E0"));  // ldrsb pc, [r0], -r1

  registers_.current.user.gprs.pc = pc + 4u;
  EXPECT_TRUE(RunInstruction("0xD1001FE0"));  // ldrsb r0, [pc], -r1
}
...
TEST_F(ExecuteTest, LDRSB_DAW_I12) {
  ...
  EXPECT_FALSE(RunInstruction("0xD42050E0"));  // ldrsb r2, [r0], #-4
  EXPECT_EQ(0x2FCu, registers_.current.user.gprs.r0);
  EXPECT_EQ(-1, registers_.current.user.gprs.r2_s);
  ...
  uint32_t pc = registers_.current.user.gprs.pc;
  registers_.current.user.gprs.r0 = 0x300u;
  EXPECT_TRUE(RunInstruction("0xD4F050E0"));  // ldrsb pc, [r0], #-4

  registers_.current.user.gprs.pc = pc + 4u;
  EXPECT_TRUE(RunInstruction("0xD4005FE0"));  // ldrsb r0, [pc], #-4
}
...
TEST_F(ExecuteTest, LDRSB_DB) {
  ...
  EXPECT_FALSE(RunInstruction("0xD12010E1"));  // ldrsb r2, [r0, -r1]
  EXPECT_EQ(-1, registers_.current.user.gprs.r2_s);

  // Modifies PC
  registers_.current.user.gprs.r0 = 0x304u;
  EXPECT_TRUE(RunInstruction("0xD1F010E1"));  // ldrsb pc, [r0, -r1]
}
...
TEST_F(ExecuteTest, LDRSB_DB_I12) {
  ...
  EXPECT_FALSE(RunInstruction("0xD42050E1"));  // ldrsb r2, [r0, #-4]
  EXPECT_EQ(-1, registers_.current.user.gprs.r2_s);

  // Modifies PC
  registers_.current.user.gprs.r0 = 0x304u;
  EXPECT_TRUE(RunInstruction("0xD4F050E1"));  // ldrsb pc, [r0, #-4]
}
...
TEST_F(ExecuteTest, LDRSB_DBW) {
  ...
  EXPECT_FALSE(RunInstruction("0xD12030E1"));  // ldrsb r2, [r0, -r1]!
  EXPECT_EQ(0x300u, registers_.current.user.gprs.r0);
  EXPECT_EQ(-1, registers_.current.user.gprs.r2_s);
  ...
  uint32_t pc = registers_.current.user.gprs.pc;
  registers_.current.user.gprs.r0 = 0x304u;
  EXPECT_TRUE(RunInstruction("0xD1F030E1"));  // ldrsb pc, [r0, -r1]!

  registers_.current.user.gprs.pc = pc + 4u;
  EXPECT_TRUE(RunInstruction("0xD1003FE1"));  // ldrsb r0, [pc, -r1]!
}
...
TEST_F(ExecuteTest, LDRSB_DBW_I12) {
  ...
  EXPECT_FALSE(RunInstruction("0xD42070E1"));  // ldrsb r2, [r0, #-4]!
  EXPECT_EQ(0x300u, registers_.current.user.gprs.r0);
  EXPECT_EQ(-1, registers_.current.user.gprs.r2_s);
  ...
  uint32_t pc = registers_.current.user.gprs.pc;
  registers_.current.user.gprs.r0 = 0x304u;
  EXPECT_TRUE(RunInstruction("0xD4F070E1"));  // ldrsb pc, [r0, #-4]!

  registers_.current.user.gprs.pc = pc + 4u;
  EXPECT_TRUE(RunInstruction("0xD4007FE1"));  // ldrsb r0, [pc, #-4]!
}
...
TEST_F(ExecuteTest, LDRSB_IAW) {
  ...
  EXPECT_FALSE(RunInstruction("0xD12090E0"));  // ldrsb r2, [r0], r1
  EXPECT_EQ(0x304u, registers_.current.user.gprs.r0);
  EXPECT_EQ(-1, registers_.current.user.gprs.r2_s);
  ...
  uint32_t pc = registers_.current.user.gprs.pc;
  registers_.current.user.gprs.r0 = 0x304u;
  EXPECT_TRUE(RunInstruction("0xD1F090E0"));  // ldrsb pc, [r0], r1

  registers_.current.user.gprs.pc = pc + 4u;
  EXPECT_TRUE(RunInstruction("0xD1009FE0"));  // ldrsb r0, [pc], r1
}
...
TEST_F(ExecuteTest, LDRSB_IAW_I12) {
  ...
  EXPECT_FALSE(RunInstruction("0xD420D0E0"));  // ldrsb r2, [r0], #4
  EXPECT_EQ(0x304u, registers_.current.user.gprs.r0);
  EXPECT_EQ(-1, registers_.current.user.gprs.r2_s);
  ...
  uint32_t pc = registers_.current.user.gprs.pc;
  registers_.current.user.gprs.r0 = 0x300u;
  EXPECT_TRUE(RunInstruction("0xD4F0D0E0"));  // ldrsb pc, [r0], #4

  registers_.current.user.gprs.pc = pc + 4u;
  EXPECT_TRUE(RunInstruction("0xD400DFE0"));  // ldrsb r0, [pc], #4
}
...
TEST_F(ExecuteTest, LDRSB_IB) {
  ...
  EXPECT_FALSE(RunInstruction("0xD12090E1"));  // ldrsb r2, [r0, r1]
  EXPECT_EQ(-1, registers_.current.user.gprs.r2_s);

  // Modifies PC
  registers_.current.user.gprs.r0 = 0x2FC;
  EXPECT_TRUE(RunInstruction("0xD1F090E1"));  // ldrsb pc, [r0, r1]
}
...
TEST_F(ExecuteTest, LDRSB_IB_I12) {
  ...
  EXPECT_FALSE(RunInstruction("0xD420D0E1"));  // ldrsb r2, [r0, #4]
  EXPECT_EQ(-1, registers_.current.user.gprs.r2_s);

  // Modifies PC
  registers_.current.user.gprs.r0 = 0x2FC;
  EXPECT_TRUE(RunInstruction("0xD4F0D0E1"));  // ldrsb pc, [r0, #4]
}
...
TEST_F(ExecuteTest, LDRSB_IBW) {
  ...
  EXPECT_FALSE(RunInstruction("0xD120B0E1"));  // ldrsb r2, [r0, r1]!
  EXPECT_EQ(0x300u, registers_.current.user.gprs.r0);
  EXPECT_EQ(-1, registers_.current.user.gprs.r2_s);
  ...
  uint32_t pc = registers_.current.user.gprs.pc;
  registers_.current.user.gprs.r0 = 0x2FCu;
  EXPECT_TRUE(RunInstruction("0xD1F0B0E1"));  // ldrsb pc, [r0, r1]!

  registers_.current.user.gprs.pc = pc + 4u;
  EXPECT_TRUE(RunInstruction("0xD100BFE1"));  // ldrsb r0, [pc, r1]!
}
...
TEST_F(ExecuteTest, LDRSB_IBW_I12) {
  ...
  EXPECT_FALSE(RunInstruction("0xD420F0E1"));  // ldrsb r2, [r0, #4]!
  EXPECT_EQ(0x300u, registers_.current.user.gprs.r0);
  EXPECT_EQ(-1, registers_.current.user.gprs.r2_s);
  ...
  uint32_t pc = registers_.current.user.gprs.pc;
  registers_.current.user.gprs.r0 = 0x2FCu;
  EXPECT_TRUE(RunInstruction("0xD4F0F0E1"));  // ldrsb pc, [r0, #4]!

  registers_.current.user.gprs.pc = pc + 4u;
  EXPECT_TRUE(RunInstruction("0xD400FFE1"));  // ldrsb r0, [pc, #4]!
}
...
TEST_F(ExecuteTest, LDRSH_DAW) {
  ...
  EXPECT_FALSE(RunInstruction("0xF12010E0"));  // ldrsh r2, [r0], -r1
  EXPECT_EQ(0x2FCu, registers_.current.user.gprs.r0);
  EXPECT_EQ(-1, registers_.current.user.gprs.r2_s);
  ...
  uint32_t pc = registers_.current.user.gprs.pc;
  registers_.current.user.gprs.r0 = 0x300u;
  EXPECT_TRUE(RunInstruction("0xF1F010E0"));  // ldrsh pc, [r0], -r1

  registers_.current.user.gprs.pc = pc + 4u;
  EXPECT_TRUE(RunInstruction("0xF1001FE0"));  // ldrsh r0, [pc], -r1
}
...
TEST_F(ExecuteTest, LDRSH_DAW_I12) {
  ...
  EXPECT_FALSE(RunInstruction("0xF42050E0"));  // ldrsh r2, [r0], #-4
  EXPECT_EQ(0x2FCu, registers_.current.user.gprs.r0);
  EXPECT_EQ(-1, registers_.current.user.gprs.r2_s);
  ...
  uint32_t pc = registers_.current.user.gprs.pc;
  registers_.current.user.gprs.r0 = 0x300u;
  EXPECT_TRUE(RunInstruction("0xF4F050E0"));  // ldrsh pc, [r0], #-4

  registers_.current.user.gprs.pc = pc + 4u;
  EXPECT_TRUE(RunInstruction("0xF4005FE0"));  // ldrsh r0, [pc], #-4
}
...
TEST_F(ExecuteTest, LDRSH_DB) {
  ...
  EXPECT_FALSE(RunInstruction("0xF12010E1"));  // ldrsh r2, [r0, -r1]
  EXPECT_EQ(-1, registers_.current.user.gprs.r2_s);

  // Modifies PC
  registers_.current.user.gprs.r0 = 0x304u;
  EXPECT_TRUE(RunInstruction("0xF1F010E1"));  // ldrsh pc, [r0, -r1]
}
...
TEST_F(ExecuteTest, LDRSH_DB_I12) {
  ...
  EXPECT_FALSE(RunInstruction("0xF42050E1"));  // ldrsh r2, [r0, #-4]
  EXPECT_EQ(-1, registers_.current.user.gprs.r2_s);

  // Modifies PC
  registers_.current.user.gprs.r0 = 0x304u;
  EXPECT_TRUE(RunInstruction("0xF4F050E1"));  // ldrsh pc, [r0, #-4]
}
...
TEST_F(ExecuteTest, LDRSH_DBW) {
  ...
  EXPECT_FALSE(RunInstruction("0xF12030E1"));  // ldrsh r2, [r0, -r1]!
  EXPECT_EQ(0x300u, registers_.current.user.gprs.r0);
  EXPECT_EQ(-1, registers_.current.user.gprs.r2_s);
  ...
  uint32_t pc = registers_.current.user.gprs.pc;
  registers_.current.user.gprs.r0 = 0x304u;
  EXPECT_TRUE(RunInstruction("0xF1F030E1"));  // ldrsh pc, [r0, -r1]!

  registers_.current.user.gprs.pc = pc + 4u;
  EXPECT_TRUE(RunInstruction("0xF1003FE1"));  // ldrsh r0, [pc, -r1]!
}
...
TEST_F(ExecuteTest, LDRSH_DBW_I12) {
  ...
  EXPECT_FALSE(RunInstruction("0xF42070E1"));  // ldrsh r2, [r0, #-4]!
  EXPECT_EQ(0x300u, registers_.current.user.gprs.r0);
  EXPECT_EQ(-1, registers_.current.user.gprs.r2_s);
  ...
  uint32_t pc = registers_.current.user.gprs.pc;
  registers_.current.user.gprs.r0 = 0x304u;
  EXPECT_TRUE(RunInstruction("0xF4F070E1"));  // ldrsh pc, [r0, #-4]!

  registers_.current.user.gprs.pc = pc + 4u;
  EXPECT_TRUE(RunInstruction("0xF4007FE1"));  // ldrsh r0, [pc, #-4]!
}
...
TEST_F(ExecuteTest, LDRSH_IAW) {
  ...
  EXPECT_FALSE(RunInstruction("0xF12090E0"));  // ldrsh r2, [r0], r1
  EXPECT_EQ(0x304u, registers_.current.user.gprs.r0);
  EXPECT_EQ(-1, registers_.current.user.gprs.r2_s);
  ...
  uint32_t pc = registers_.current.user.gprs.pc;
  registers_.current.user.gprs.r0 = 0x304u;
  EXPECT_TRUE(RunInstruction("0xF1F090E0"));  // ldrsh pc, [r0], r1

  registers_.current.user.gprs.pc = pc + 4u;
  EXPECT_TRUE(RunInstruction("0xF1009FE0"));  // ldrsh r0, [pc], r1
}
...
TEST_F(ExecuteTest, LDRSH_IAW_I12) {
  ...
  EXPECT_FALSE(RunInstruction("0xF420D0E0"));  // ldrsh r2, [r0], #4
  EXPECT_EQ(0x304u, registers_.current.user.gprs.r0);
  EXPECT_EQ(-1, registers_.current.user.gprs.r2_s);
  ...
  uint32_t pc = registers_.current.user.gprs.pc;
  registers_.current.user.gprs.r0 = 0x300u;
  EXPECT_TRUE(RunInstruction("0xF4F0D0E0"));  // ldrsh pc, [r0], #4

  registers_.current.user.gprs.pc = pc + 4u;
  EXPECT_TRUE(RunInstruction("0xF400DFE0"));  // ldrsh r0, [pc], #4
}
...
TEST_F(ExecuteTest, LDRSH_IB) {
  ...
  EXPECT_FALSE(RunInstruction("0xF12090E1"));  // ldrsh r2, [r0, r1]
  EXPECT_EQ(-1, registers_.current.user.gprs.r2_s);

  // Modifies PC
  registers_.current.user.gprs.r0 = 0x2FC;
  EXPECT_TRUE(RunInstruction("0xF1F090E1"));  // ldrsh pc, [r0, r1]
}
...
TEST_F(ExecuteTest, LDRSH_IB_I12) {
  ...
  EXPECT_FALSE(RunInstruction("0xF420D0E1"));  // ldrsh r2, [r0, #4]
  EXPECT_EQ(-1, registers_.current.user.gprs.r2_s);

  // Modifies PC
  registers_.current.user.gprs.r0 = 0x2FC;
  EXPECT_TRUE(RunInstruction("0xF4F0D0E1"));  // ldrsh pc, [r0, #4]
}
...
TEST_F(ExecuteTest, LDRSH_IBW) {
  ...
  EXPECT_FALSE(RunInstruction("0xF120B0E1"));  // ldrsh r2, [r0, r1]!
  EXPECT_EQ(0x300u, registers_.current.user.gprs.r0);
  EXPECT_EQ(-1, registers_.current.user.gprs.r2_s);
  ...
  uint32_t pc = registers_.current.user.gprs.pc;
  registers_.current.user.gprs.r0 = 0x2FCu;
  EXPECT_TRUE(RunInstruction("0xF1F0B0E1"));  // ldrsh pc, [r0, r1]!

  registers_.current.user.gprs.pc = pc + 4u;
  EXPECT_TRUE(RunInstruction("0xF100BFE1"));  // ldrsh r0, [pc, r1]!
}
...
TEST_F(ExecuteTest, LDRSH_IBW_I12) {
  ...
  EXPECT_FALSE(RunInstruction("0xF420F0E1"));  // ldrsh r2, [r0, #4]!
  EXPECT_EQ(0x300u, registers_.current.user.gprs.r0);
  EXPECT_EQ(-1, registers_.current.user.gprs.r2_s);
  ...
  uint32_t pc = registers_.current.user.gprs.pc;
  registers_.current.user.gprs.r0 = 0x2FCu;
  EXPECT_TRUE(RunInstruction("0xF4F0F0E1"));  // ldrsh pc, [r0, #4]!

  registers_.current.user.gprs.pc = pc + 4u;
  EXPECT_TRUE(RunInstruction("0xF400FFE1"));  // ldrsh r0, [pc, #4]!
}
...
TEST_F(ExecuteTest, LDRT_DAW) {
  ...
  EXPECT_FALSE(RunInstruction("0x012030E6"));  // ldrt r2, [r0], -r1
  EXPECT_EQ(0x2FCu, registers_.current.user.gprs.r0);
  EXPECT_EQ(1u, registers_.current.user.gprs.r2);
  ...
  uint32_t pc = registers_.current.user.gprs.pc;
  registers_.current.user.gprs.r0 = 0x300u;
  EXPECT_TRUE(RunInstruction("0x01F030E6"));  // ldrt pc, [r0], -r1

  registers_.current.user.gprs.pc = pc + 4u;
  EXPECT_TRUE(RunInstruction("0x01003FE6"));  // ldrt r0, [pc], -r1
}
...
TEST_F(ExecuteTest, LDRT_DAW_I12) {
  ...
  EXPECT_FALSE(RunInstruction("0x042030E4"));  // ldrt r2, [r0], #-4
  EXPECT_EQ(0x2FCu, registers_.current.user.gprs.r0);
  EXPECT_EQ(1u, registers_.current.user.gprs.r2);
  ...
  uint32_t pc = registers_.current.user.gprs.pc;
  registers_.current.user.gprs.r0 = 0x300u;
  EXPECT_TRUE(RunInstruction("0x04F030E4"));  // ldrt pc, [r0], #-4

  registers_.current.user.gprs.pc = pc + 4u;
  EXPECT_TRUE(RunInstruction("0x04003FE4"));  // ldrt r0, [pc], #-4
}
...
TEST_F(ExecuteTest, LDRT_IAW) {
  ...
  EXPECT_FALSE(RunInstruction("0x0120B0E6"));  // ldrt r2, [r0], r1
  EXPECT_EQ(0x304u, registers_.current.user.gprs.r0);
  EXPECT_EQ(1u, registers_.current.user.gprs.r2);
  ...
  uint32_t pc = registers_.current.user.gprs.pc;
  registers_.current.user.gprs.r0 = 0x304u;
  EXPECT_TRUE(RunInstruction("0x01F0B0E6"));  // ldrt pc, [r0], r1

  registers_.current.user.gprs.pc = pc + 4u;
  EXPECT_TRUE(RunInstruction("0x0100BFE6"));  // ldrt r0, [pc], r1
}
...
TEST_F(ExecuteTest, LDRT_IAW_I12) {
  ...
  EXPECT_FALSE(RunInstruction("0x0420B0E4"));  // ldrt r2, [r0], #4
  EXPECT_EQ(0x304u, registers_.current.user.gprs.r0);
  EXPECT_EQ(1u, registers_.current.user.gprs.r2);
  ...
  uint32_t pc = registers_.current.user.gprs.pc;
  registers_.current.user.gprs.r0 = 0x300u;
  EXPECT_TRUE(RunInstruction("0x04F0B0E4"));  // ldrt pc, [r0], #4

  registers_.current.user.gprs.pc = pc + 4u;
  EXPECT_TRUE(RunInstruction("0x0400BFE4"));  // ldrt r0, [pc], #4
}
...
TEST_F(ExecuteTest, STMDA) {
  ...
  EXPECT_FALSE(RunInstruction("0x0E0000E8"));  // stmda r0, {r1-r3}
  uint32_t value;
  ...
  // Modifies PC
  registers_.current.user.gprs.r0 = 0x308u;
  EXPECT_FALSE(RunInstruction("0x038000E8"));  // stmda r0, {r0, r1, pc}
}
...
TEST_F(ExecuteTest, STMDA_W) {
  ...
  registers_.current.user.gprs.r2 = 2u;
  registers_.current.user.gprs.r3 = 3u;
  EXPECT_FALSE(RunInstruction("0x0E0020E8"));  // stmda r0!, {r1-r3}
  EXPECT_EQ(0x2FCu, registers_.current.user.gprs.r0);
  uint32_t value;
  ASSERT_TRUE(Load32LE(nullptr, 0x300, &value));
  EXPECT_EQ(1u, value);
  ...
  uint32_t pc = registers_.current.user.gprs.pc;
  registers_.current.user.gprs.r0 = 0x308u;
  EXPECT_FALSE(RunInstruction("0x068020E8"));  // stmda r0!, {r1, r2, pc}

  registers_.current.user.gprs.pc = pc + 4u;
  EXPECT_TRUE(RunInstruction("0x0E002FE8"));  // stmda pc!, {r1-r3}
}
...
TEST_F(ExecuteTest, STMDB) {
  ...
  registers_.current.user.gprs.r2 = 2u;
  registers_.current.user.gprs.r3 = 3u;
  EXPECT_FALSE(RunInstruction("0x0E0000E9"));  // stmdb r0, {r1-r3}
  uint32_t value;
  ASSERT_TRUE(Load32LE(nullptr, 0x300, &value));
  EXPECT_EQ(1u, value);
  ASSERT_TRUE(Load32LE(nullptr, 0x304, &value));
  ...
  registers_.current.user.gprs.r0 = 0x30Cu;
  EXPECT_FALSE(RunInstruction("0x038000E9"));  // stmdb r0, {r0, r1, pc}
}
...
TEST_F(ExecuteTest, STMDB_W) {
  ...
  registers_.current.user.gprs.r2 = 2u;
  registers_.current.user.gprs.r3 = 3u;
  EXPECT_FALSE(RunInstruction("0x0E0020E9"));  // stmdb r0!, {r1-r3}
  EXPECT_EQ(0x300u, registers_.current.user.gprs.r0);
  uint32_t value;
  ASSERT_TRUE(Load32LE(nullptr, 0x300, &value));
  EXPECT_EQ(1u, value);
  ...
  uint32_t pc = registers_.current.user.gprs.pc;
  registers_.current.user.gprs.r0 = 0x30Cu;
  EXPECT_FALSE(RunInstruction("0x068020E9"));  // stmdb r0!, {r1, r2, pc}

  // Modifies PC
  registers_.current.user.gprs.pc = pc + 4u;
  EXPECT_TRUE(RunInstruction("0x0E002FE9"));  // stmdb pc!, {r1-r3}
}
...
TEST_F(ExecuteTest, STMIA) {
  ...
  registers_.current.user.gprs.r2 = 2u;
  registers_.current.user.gprs.r3 = 3u;
  EXPECT_FALSE(RunInstruction("0x0E0080E8"));  // stmia r0, {r1-r3}
  uint32_t value;
  ASSERT_TRUE(Load32LE(nullptr, 0x300, &value));
  EXPECT_EQ(1u, value);
  ASSERT_TRUE(Load32LE(nullptr, 0x304, &value));
  ...
  registers_.current.user.gprs.r0 = 0x300u;
  EXPECT_FALSE(RunInstruction("0x038080E8"));  // stmia r0, {r0, r1, pc}
}
...
TEST_F(ExecuteTest, STMIA_W) {
  ...
  registers_.current.user.gprs.r2 = 2u;
  registers_.current.user.gprs.r3 = 3u;
  EXPECT_FALSE(RunInstruction("0x0E00A0E8"));  // stmia r0!, {r1-r3}
  EXPECT_EQ(0x30Cu, registers_.current.user.gprs.r0);
  uint32_t value;
  ASSERT_TRUE(Load32LE(nullptr, 0x300, &value));
  EXPECT_EQ(1u, value);
  ...
  uint32_t pc = registers_.current.user.gprs.pc;
  registers_.current.user.gprs.r0 = 0x300u;
  EXPECT_FALSE(RunInstruction("0x0680A0E8"));  // stmia r0!, {r1, r2, pc}

  // Modifies PC
  registers_.current.user.gprs.pc = pc + 4u;
  EXPECT_TRUE(RunInstruction("0x0E00AFE8"));  // stmia pc!, {r1-r3}
}
...
TEST_F(ExecuteTest, STMIB) {
  ...
  registers_.current.user.gprs.r2 = 2u;
  registers_.current.user.gprs.r3 = 3u;
  EXPECT_FALSE(RunInstruction("0x0E0080E9"));  // stmib r0, {r1-r3}
  uint32_t value;
  ASSERT_TRUE(Load32LE(nullptr, 0x300, &value));
  EXPECT_EQ(1u, value);
  ASSERT_TRUE(Load32LE(nullptr, 0x304, &value));
  ...
  registers_.current.user.gprs.r0 = 0x2FCu;
  EXPECT_FALSE(RunInstruction("0x038080E9"));  // stmib r0, {r0, r1, pc}
}
...
TEST_F(ExecuteTest, STMIB_W) {
  ...
  registers_.current.user.gprs.r2 = 2u;
  registers_.current.user.gprs.r3 = 3u;
  EXPECT_FALSE(RunInstruction("0x0E00A0E9"));  // stmib r0!, {r1-r3}
  EXPECT_EQ(0x308u, registers_.current.user.gprs.r0);
  uint32_t value;
  ASSERT_TRUE(Load32LE(nullptr, 0x300, &value));
  EXPECT_EQ(1u, value);
  ...
  uint32_t pc = registers_.current.user.gprs.pc;
  registers_.current.user.gprs.r0 = 0x2FCu;
  EXPECT_FALSE(RunInstruction("0x0680A0E9"));  // stmib r0!, {r1, r2, pc}

  // Modifies PC
  registers_.current.user.gprs.pc = pc + 4u;
  EXPECT_TRUE(RunInstruction("0x0E00AFE9"));  // stmib pc!, {r1-r3}
}
...
TEST_F(ExecuteTest, STMSDA) {
  ...
  registers_.current.user.gprs.r2 = 2u;
  registers_.current.user.gprs.r3 = 3u;
  EXPECT_FALSE(RunInstruction("0x0E0040E8"));  // stmda r0, {r1-r3}^
  uint32_t value;
  ASSERT_TRUE(Load32LE(nullptr, 0x300, &value));
  EXPECT_EQ(1u, value);
  ASSERT_TRUE(Load32LE(nullptr, 0x304, &value));
  ...
  registers_.current.user.gprs.r0 = 0x308u;
  EXPECT_FALSE(RunInstruction("0x068040E8"));  // stmda r0, {r1, r2, pc}^
}
...
TEST_F(ExecuteTest, STMSDA_W) {
  ...
  registers_.current.user.gprs.r2 = 2u;
  registers_.current.user.gprs.r3 = 3u;
  EXPECT_FALSE(RunInstruction("0x0E0060E8"));  // stmda r0!, {r1-r3}^
  EXPECT_EQ(0x2FCu, registers_.current.user.gprs.r0);
  uint32_t value;
  ASSERT_TRUE(Load32LE(nullptr, 0x300, &value));
  EXPECT_EQ(1u, value);
  ...
  uint32_t pc = registers_.current.user.gprs.pc;
  registers_.current.user.gprs.r0 = 0x308u;
  EXPECT_FALSE(RunInstruction("0x068060E8"));  // stmda r0!, {r1, r2, pc}^

  // Modifies PC
  registers_.current.user.gprs.pc = pc + 4u;
  EXPECT_TRUE(RunInstruction("0x0E006FE8"));  // stmda pc!, {r1-r3}^
}
...
TEST_F(ExecuteTest, STMSDB) {
  ...
  registers_.current.user.gprs.r2 = 2u;
  registers_.current.user.gprs.r3 = 3u;
  EXPECT_FALSE(RunInstruction("0x0E0040E9"));  // stmdb r0, {r1-r3}^
  uint32_t value;
  ASSERT_TRUE(Load32LE(nullptr, 0x300, &value));
  EXPECT_EQ(1u, value);
  ASSERT_TRUE(Load32LE(nullptr, 0x304, &value));
  ...
  registers_.current.user.gprs.r0 = 0x30Cu;
  EXPECT_FALSE(RunInstruction("0x068040E9"));  // stmdb r0, {r1, r2, pc}^
}
...
TEST_F(ExecuteTest, STMSDB_W) {
  ...
  registers_.current.user.gprs.r2 = 2u;
  registers_.current.user.gprs.r3 = 3u;
  EXPECT_FALSE(RunInstruction("0x0E0060E9"));  // stmdb r0!, {r1-r3}^
  EXPECT_EQ(0x300u, registers_.current.user.gprs.r0);
  uint32_t value;
  ASSERT_TRUE(Load32LE(nullptr, 0x300, &value));
  EXPECT_EQ(1u, value);
  ...
  uint32_t pc = registers_.current.user.gprs.pc;
  registers_.current.user.gprs.r0 = 0x30Cu;
  EXPECT_FALSE(RunInstruction("0x068060E9"));  // stmdb r0!, {r1, r2, pc}^

  // Modifies PC
  registers_.current.user.gprs.pc = pc + 4u;
  EXPECT_TRUE(RunInstruction("0x0E006FE9"));  // stmdb pc!, {r1-r3}^
}
...
TEST_F(ExecuteTest, STMSIA) {
  ...
  registers_.current.user.gprs.r2 = 2u;
  registers_.current.user.gprs.r3 = 3u;
  EXPECT_FALSE(RunInstruction("0x0E00C0E8"));  // stmia r0, {r1-r3}^
  uint32_t value;
  ASSERT_TRUE(Load32LE(nullptr, 0x300, &value));
  EXPECT_EQ(1u, value);
  ASSERT_TRUE(Load32LE(nullptr, 0x304, &value));
  ...
  registers_.current.user.gprs.r0 = 0x300u;
  EXPECT_FALSE(RunInstruction("0x0380C0E8"));  // stmia r0, {r0, r1, pc}^
}
...
TEST_F(ExecuteTest, STMSIA_W) {
  ...
  registers_.current.user.gprs.r2 = 2u;
  registers_.current.user.gprs.r3 = 3u;
  EXPECT_FALSE(RunInstruction("0x0E00E0E8"));  // stmia r0!, {r1-r3}^
  EXPECT_EQ(0x30Cu, registers_.current.user.gprs.r0);
  uint32_t value;
  ASSERT_TRUE(Load32LE(nullptr, 0x300, &value));
  EXPECT_EQ(1u, value);
  ...
  uint32_t pc = registers_.current.user.gprs.pc;
  registers_.current.user.gprs.r0 = 0x300u;
  EXPECT_FALSE(RunInstruction("0x0680E0E8"));  // stmia r0!, {r1, r2, pc}^

  // Modifies PC
  registers_.current.user.gprs.pc = pc + 4u;
  EXPECT_TRUE(RunInstruction("0x0E00EFE8"));  // stmia pc!, {r1-r3}^
}
...
TEST_F(ExecuteTest, STMSIB) {
  ...
  registers_.current.user.gprs.r2 = 2u;
  registers_.current.user.gprs.r3 = 3u;
  EXPECT_FALSE(RunInstruction("0x0E00C0E9"));  // stmib r0, {r1-r3}^
  uint32_t value;
  ASSERT_TRUE(Load32LE(nullptr, 0x300, &value));
  EXPECT_EQ(1u, value);
  ASSERT_TRUE(Load32LE(nullptr, 0x304, &value));
  ...
  registers_.current.user.gprs.r0 = 0x2FCu;
  EXPECT_FALSE(RunInstruction("0x0380C0E9"));  // stmib r0, {r0, r1, pc}^
}
...
TEST_F(ExecuteTest, STMSIB_W) {
  ...
  registers_.current.user.gprs.r2 = 2u;
  registers_.current.user.gprs.r3 = 3u;
  EXPECT_FALSE(RunInstruction("0x0E00E0E9"));  // stmib r0!, {r1-r3}^
  EXPECT_EQ(0x308u, registers_.current.user.gprs.r0);
  uint32_t value;
  ASSERT_TRUE(Load32LE(nullptr, 0x300, &value));
  EXPECT_EQ(1u, value);
  ...
  uint32_t pc = registers_.current.user.gprs.pc;
  registers_.current.user.gprs.r0 = 0x2FCu;
  EXPECT_FALSE(RunInstruction("0x0680E0E9"));  // stmib r0!, {r1, r2, pc}^
...
TEST_F(ExecuteTest, STRB_DAW) {
  ...
  EXPECT_FALSE(RunInstruction("0x012040E6"));  // strb r2, [r0], -r1
  EXPECT_EQ(0x2FCu, registers_.current.user.gprs.r0);
  uint8_t value;
  ...
  // Modifies PC
  registers_.current.user.gprs.r0 = 0x300u;
  EXPECT_TRUE(RunInstruction("0x01004FE6"));  // strb r0, [pc], -r1
}
...
TEST_F(ExecuteTest, STRB_DAW_I12) {
  ...
  EXPECT_FALSE(RunInstruction("0x042040E4"));  // strb r2, [r0], #-4
  EXPECT_EQ(0x2FCu, registers_.current.user.gprs.r0);
  uint8_t value;
  ASSERT_TRUE(Load8(nullptr, 0x300, &value));
  EXPECT_EQ(1u, value);
  ...
  // Modifies PC
  registers_.current.user.gprs.r0 = 0x300u;
  EXPECT_TRUE(RunInstruction("0x04004FE4"));  // strb r0, [pc], #-4
}
...
TEST_F(ExecuteTest, STRB_DB) {
  ...
  EXPECT_FALSE(RunInstruction("0x012040E7"));  // strb r2, [r0, -r1]
  uint8_t value;
  ASSERT_TRUE(Load8(nullptr, 0x300, &value));
  EXPECT_EQ(1u, value);
}
...
TEST_F(ExecuteTest, STRB_DB_I12) {
  ...
  EXPECT_FALSE(RunInstruction("0x042040E5"));  // strb r2, [r0, #-4]
  uint8_t value;
  ASSERT_TRUE(Load8(nullptr, 0x300, &value));
  EXPECT_EQ(1u, value);
}
...
TEST_F(ExecuteTest, STRB_DBW) {
  ...
  EXPECT_FALSE(RunInstruction("0x012060E7"));  // strb r2, [r0, -r1]!
  EXPECT_EQ(0x300u, registers_.current.user.gprs.r0);
  uint8_t value;
  ASSERT_TRUE(Load8(nullptr, 0x300, &value));
  EXPECT_EQ(1u, value);
  ...
  // Modifies PC
  registers_.current.user.gprs.r0 = 0x304u;
  EXPECT_TRUE(RunInstruction("0x01006FE7"));  // strb r0, [pc, -r1]!
}
...
TEST_F(ExecuteTest, STRB_DBW_I12) {
  ...
  EXPECT_FALSE(RunInstruction("0x042060E5"));  // strb r2, [r0, #-4]!
  EXPECT_EQ(0x300u, registers_.current.user.gprs.r0);
  uint8_t value;
  ASSERT_TRUE(Load8(nullptr, 0x300, &value));
  EXPECT_EQ(1u, value);
  ...
  // Modifies PC
  registers_.current.user.gprs.r0 = 0x304u;
  EXPECT_TRUE(RunInstruction("0x04006FE5"));  // strb r0, [pc, #-4]!
}
...
TEST_F(ExecuteTest, STRB_IAW) {
  ...
  EXPECT_FALSE(RunInstruction("0x0120C0E6"));  // strb r2, [r0], r1
  EXPECT_EQ(0x304u, registers_.current.user.gprs.r0);
  uint8_t value;
  ASSERT_TRUE(Load8(nullptr, 0x300, &value));
  EXPECT_EQ(1u, value);
  ...
  // Modifies PC
  registers_.current.user.gprs.r0 = 0x304u;
  EXPECT_TRUE(RunInstruction("0x0100CFE6"));  // strb r0, [pc], r1
}
...
TEST_F(ExecuteTest, STRB_IAW_I12) {
  ...
  EXPECT_FALSE(RunInstruction("0x0420C0E4"));  // strb r2, [r0], #4
  EXPECT_EQ(0x304u, registers_.current.user.gprs.r0);
  uint8_t value;
  ASSERT_TRUE(Load8(nullptr, 0x300, &value));
  EXPECT_EQ(1u, value);
  ...
  // Modifies PC
  registers_.current.user.gprs.r0 = 0x300u;
  EXPECT_TRUE(RunInstruction("0x0400CFE4"));  // strb r0, [pc], #4
}
...
TEST_F(ExecuteTest, STRB_IB) {
  ...
  EXPECT_FALSE(RunInstruction("0x0120C0E7"));  // strb r2, [r0, r1]
  uint8_t value;
  ASSERT_TRUE(Load8(nullptr, 0x300, &value));
  EXPECT_EQ(1u, value);
}
...
TEST_F(ExecuteTest, STRB_IB_I12) {
  ...
  EXPECT_FALSE(RunInstruction("0x0420C0E5"));  // strb r2, [r0, #4]
  uint8_t value;
  ASSERT_TRUE(Load8(nullptr, 0x300, &value));
  EXPECT_EQ(1u, value);
}
...
TEST_F(ExecuteTest, STRB_IBW) {
  ...
  EXPECT_FALSE(RunInstruction("0x0120E0E7"));  // strb r2, [r0, r1]!
  EXPECT_EQ(0x300u, registers_.current.user.gprs.r0);
  uint8_t value;
  ASSERT_TRUE(Load8(nullptr, 0x300, &value));
  EXPECT_EQ(1u, value);
  ...
  uint32_t pc = registers_.current.user.gprs.pc;
  registers_.current.user.gprs.r0 = 0x2FCu;
  EXPECT_FALSE(RunInstruction("0x01F0E0E7"));  // strb pc, [r0, r1]!

  registers_.current.user.gprs.pc = pc + 4u;
  EXPECT_TRUE(RunInstruction("0x0100EFE7"));  // strb r0, [pc, r1]!
}
...
TEST_F(ExecuteTest, STRB_IBW_I12) {
  ...
  EXPECT_FALSE(RunInstruction("0x0420E0E5"));  // strb r2, [r0, #4]!
  EXPECT_EQ(0x300u, registers_.current.user.gprs.r0);
  uint8_t value;
  ASSERT_TRUE(Load8(nullptr, 0x300, &value));
  EXPECT_EQ(1u, value);
  ...
  // Modifies PC
  registers_.current.user.gprs.r0 = 0x2FCu;
  EXPECT_TRUE(RunInstruction("0x0400EFE5"));  // strb r0, [pc, #4]!
}
...
TEST_F(ExecuteTest, STRBT_DAW) {
  ...
  EXPECT_FALSE(RunInstruction("0x012060E6"));  // strbt r2, [r0], -r1
  EXPECT_EQ(0x2FCu, registers_.current.user.gprs.r0);
  uint8_t value;
  ASSERT_TRUE(Load8(nullptr, 0x300, &value));
  EXPECT_EQ(1u, value);
  ...
  // Modifies PC
  registers_.current.user.gprs.r0 = 0x300u;
  EXPECT_TRUE(RunInstruction("0x01006FE6"));  // strbt r0, [pc], -r1
}
...
TEST_F(ExecuteTest, STRBT_DAW_I12) {
  ...
  EXPECT_FALSE(RunInstruction("0x042060E4"));  // strbt r2, [r0], #-4
  EXPECT_EQ(0x2FCu, registers_.current.user.gprs.r0);
  uint8_t value;
  ASSERT_TRUE(Load8(nullptr, 0x300, &value));
  EXPECT_EQ(1u, value);
  ...
  // Modifies PC
  registers_.current.user.gprs.r0 = 0x300u;
  EXPECT_TRUE(RunInstruction("0x04006FE4"));  // strbt r0, [pc], #-4
}
...
TEST_F(ExecuteTest, STRBT_IAW) {
  ...
  EXPECT_FALSE(RunInstruction("0x0120E0E6"));  // strbt r2, [r0], r1
  EXPECT_EQ(0x304u, registers_.current.user.gprs.r0);
  uint8_t value;
  ASSERT_TRUE(Load8(nullptr, 0x300, &value));
  EXPECT_EQ(1u, value);
  ...
  // Modifies PC
  registers_.current.user.gprs.r0 = 0x304u;
  EXPECT_TRUE(RunInstruction("0x0100EFE6"));  // strbt r0, [pc], r1
}
...
TEST_F(ExecuteTest, STRBT_IAW_I12) {
  ...
  EXPECT_FALSE(RunInstruction("0x0420E0E4"));  // strbt r2, [r0], #4
  EXPECT_EQ(0x304u, registers_.current.user.gprs.r0);
  uint8_t value;
  ASSERT_TRUE(Load8(nullptr, 0x300, &value));
  EXPECT_EQ(1u, value);
  ...
  // Modifies PC
  registers_.current.user.gprs.r0 = 0x300u;
  EXPECT_TRUE(RunInstruction("0x0400EFE4"));  // strbt r0, [pc], #4
}
...
TEST_F(ExecuteTest, STRH_DAW) {
  ...
  EXPECT_FALSE(RunInstruction("0xB12000E0"));  // strh r2, [r0], -r1
  EXPECT_EQ(0x2FCu, registers_.current.user.gprs.r0);
  uint16_t value;
  ...
  // Modifies PC
  registers_.current.user.gprs.r0 = 0x300u;
  EXPECT_TRUE(RunInstruction("0xB1000FE0"));  // strh r0, [pc], -r1
}
...
TEST_F(ExecuteTest, STRH_DAW_I12) {
  ...
  EXPECT_FALSE(RunInstruction("0xB42040E0"));  // strh r2, [r0], #-4
  EXPECT_EQ(0x2FCu, registers_.current.user.gprs.r0);
  uint16_t value;
  ASSERT_TRUE(Load16LE(nullptr, 0x300, &value));
  EXPECT_EQ(1u, value);
  ...
  // Modifies PC
  registers_.current.user.gprs.r0 = 0x300u;
  EXPECT_TRUE(RunInstruction("0xB4004FE0"));  // strh r0, [pc], #-4
}
...
TEST_F(ExecuteTest, STRH_DB) {
  ...
  EXPECT_FALSE(RunInstruction("0xB12000E1"));  // strh r2, [r0, -r1]
  uint16_t value;
  ASSERT_TRUE(Load16LE(nullptr, 0x300, &value));
  EXPECT_EQ(1u, value);
}
...
TEST_F(ExecuteTest, STRH_DB_I12) {
  ...
  EXPECT_FALSE(RunInstruction("0xB42040E1"));  // strh r2, [r0, #-4]
  uint16_t value;
  ASSERT_TRUE(Load16LE(nullptr, 0x300, &value));
  EXPECT_EQ(1u, value);
}
...
TEST_F(ExecuteTest, STRH_DBW) {
  ...
  EXPECT_FALSE(RunInstruction("0xB12020E1"));  // strh r2, [r0, -r1]!
  EXPECT_EQ(0x300u, registers_.current.user.gprs.r0);
  uint16_t value;
  ASSERT_TRUE(Load16LE(nullptr, 0x300, &value));
  EXPECT_EQ(1u, value);
  ...
  // Modifies PC
  registers_.current.user.gprs.r0 = 0x304u;
  EXPECT_TRUE(RunInstruction("0xB1002FE1"));  // strh r0, [pc, -r1]!
}
...
TEST_F(ExecuteTest, STRH_DBW_I12) {
  ...
  EXPECT_FALSE(RunInstruction("0xB42060E1"));  // strh r2, [r0, #-4]!
  EXPECT_EQ(0x300u, registers_.current.user.gprs.r0);
  uint16_t value;
  ASSERT_TRUE(Load16LE(nullptr, 0x300, &value));
  EXPECT_EQ(1u, value);
  ...
  // Modifies PC
  registers_.current.user.gprs.r0 = 0x304u;
  EXPECT_TRUE(RunInstruction("0xB4006FE1"));  // strh r0, [pc, #-4]!
}
...
TEST_F(ExecuteTest, STRH_IAW) {
  ...
  EXPECT_FALSE(RunInstruction("0xB12080E0"));  // strh r2, [r0], r1
  EXPECT_EQ(0x304u, registers_.current.user.gprs.r0);
  uint16_t value;
  ASSERT_TRUE(Load16LE(nullptr, 0x300, &value));
  EXPECT_EQ(1u, value);
  ...
  // Modifies PC
  registers_.current.user.gprs.r0 = 0x304u;
  EXPECT_TRUE(RunInstruction("0xB1008FE0"));  // strh r0, [pc], r1
}
...
TEST_F(ExecuteTest, STRH_IAW_I12) {
  ...
  EXPECT_FALSE(RunInstruction("0xB420C0E0"));  // strh r2, [r0], #4
  EXPECT_EQ(0x304u, registers_.current.user.gprs.r0);
  uint16_t value;
  ASSERT_TRUE(Load16LE(nullptr, 0x300, &value));
  EXPECT_EQ(1u, value);
  ...
  // Modifies PC
  registers_.current.user.gprs.r0 = 0x300u;
  EXPECT_TRUE(RunInstruction("0xB400CFE0"));  // strh r0, [pc], #4
}
...
TEST_F(ExecuteTest, STRH_IB) {
  ...
  EXPECT_FALSE(RunInstruction("0xB12080E1"));  // strh r2, [r0, r1]
  uint16_t value;
  ASSERT_TRUE(Load16LE(nullptr, 0x300, &value));
  EXPECT_EQ(1u, value);
}
...
TEST_F(ExecuteTest, STRH_IB_I12) {
  ...
  EXPECT_FALSE(RunInstruction("0xB420C0E1"));  // strh r2, [r0, #4]
  uint16_t value;
  ASSERT_TRUE(Load16LE(nullptr, 0x300, &value));
  EXPECT_EQ(1u, value);
}
...
TEST_F(ExecuteTest, STRH_IBW) {
  ...
  EXPECT_FALSE(RunInstruction("0xB120A0E1"));  // strh r2, [r0, r1]!
  EXPECT_EQ(0x300u, registers_.current.user.gprs.r0);
  uint16_t value;
  ASSERT_TRUE(Load16LE(nullptr, 0x300, &value));
  EXPECT_EQ(1u, value);
  ...
  uint32_t pc = registers_.current.user.gprs.pc;
  registers_.current.user.gprs.r0 = 0x2FCu;
  EXPECT_FALSE(RunInstruction("0xB1F0A0E1"));  // strh pc, [r0, r1]!

  registers_.current.user.gprs.pc = pc + 4u;
  EXPECT_TRUE(RunInstruction("0xB100AFE1"));  // strh r0, [pc, r1]!
}
...
TEST_F(ExecuteTest, STRH_IBW_I12) {
  ...
  EXPECT_FALSE(RunInstruction("0xB420E0E1"));  // strh r2, [r0, #4]!
  EXPECT_EQ(0x300u, registers_.current.user.gprs.r0);
  uint16_t value;
  ASSERT_TRUE(Load16LE(nullptr, 0x300, &value));
  EXPECT_EQ(1u, value);
  ...
  // Modifies PC
  registers_.current.user.gprs.r0 = 0x2FCu;
  EXPECT_TRUE(RunInstruction("0xB400EFE1"));  // strh r0, [pc, #4]!
}
...
TEST_F(ExecuteTest, STRT_DAW) {
  ...
  EXPECT_FALSE(RunInstruction("0x012020E6"));  // strt r2, [r0], -r1
  EXPECT_EQ(0x2FCu, registers_.current.user.gprs.r0);
  uint32_t value;
  ASSERT_TRUE(Load32LE(nullptr, 0x300, &value));
  EXPECT_EQ(1u, value);
  ...
  // Modifies PC
  registers_.current.user.gprs.r0 = 0x300u;
  EXPECT_TRUE(RunInstruction("0x01002FE6"));  // strt r0, [pc], -r1
}
...
TEST_F(ExecuteTest, STRT_DAW_I12) {
  ...
  EXPECT_FALSE(RunInstruction("0x042020E4"));  // strt r2, [r0], #-4
  EXPECT_EQ(0x2FCu, registers_.current.user.gprs.r0);
  uint32_t value;
  ASSERT_TRUE(Load32LE(nullptr, 0x300, &value));
  EXPECT_EQ(1u, value);
  ...
  // Modifies PC
  registers_.current.user.gprs.r0 = 0x300u;
  EXPECT_TRUE(RunInstruction("0x04002FE4"));  // strt r0, [pc], #-4
}
...
TEST_F(ExecuteTest, STRT_IAW) {
  ...
  EXPECT_FALSE(RunInstruction("0x012080E6"));  // strt r2, [r0], r1
  EXPECT_EQ(0x304u, registers_.current.user.gprs.r0);
  uint32_t value;
  ASSERT_TRUE(Load32LE(nullptr, 0x300, &value));
  EXPECT_EQ(1u, value);
  ...
  // Modifies PC
  registers_.current.user.gprs.r0 = 0x304u;
  EXPECT_TRUE(RunInstruction("0x0100AFE6"));  // strt r0, [pc], r1
}
...
TEST_F(ExecuteTest, STRT_IAW_I12) {
  ...
  EXPECT_FALSE(RunInstruction("0x0420A0E4"));  // strt r2, [r0], #4
  EXPECT_EQ(0x304u, registers_.current.user.gprs.r0);
  uint32_t value;
  ASSERT_TRUE(Load32LE(nullptr, 0x300, &value));
  EXPECT_EQ(1u, value);
  ...
  // Modifies PC
  registers_.current.user.gprs.r0 = 0x300u;
  EXPECT_TRUE(RunInstruction("0x0400AFE4"));  // strt r0, [pc], #4
}
